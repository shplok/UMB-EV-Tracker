...
class EVTracker:
    ...
    def __init__(self, output_dir: str = "UMB-EV-Tracker/out"):
    ...
    def set_params(self, 
                   ...
                   bg_window_size: Optional[int] = None) -> 'EVTracker':
    ...
    def print_params(self):
        ...
        print(f"  min_track_length: {self.min_track_length}")
        print(f"  max_frame_gap:    {self.max_frame_gap}")
        print(f"{'='*60}\n")
